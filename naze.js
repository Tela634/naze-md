...
const hariini = moment.tz('EastAfrica/Kenya').format('dddd, DD MMMM YYYY')
...
//TIME
const time2 = moment().tz('EastAfrica/Kenya').format('HH:mm:ss')  
 if(time2 < "23:59:00"){
...
let dana = `254701309409@s.whatsapp.net`
let shopeeotp = `254701309409@s.whatsapp.net`
